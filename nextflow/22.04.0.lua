...
help([[
This module loads nextflow version 22.04.0 (build 5697).
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD module for nextflow/22.04.0")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD module for nextflow/22.04.0")
end

prepend_path("PATH", "/jhpce/shared/jhpce/libd/nextflow/22.04.0")
