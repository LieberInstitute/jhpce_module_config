help([[
This module loads tensorQTL 1.0.7 for python 3.10.6 packaged with conda_R/4.2.x.
]])
...
load('conda_R/4.2.x')
prepend_path("LD_LIBRARY_PATH", "/jhpce/shared/jhpce/core/conda/miniconda3-4.11.0/envs/svnR-4.2.x/R/4.2.x/lib64/R/lib")
