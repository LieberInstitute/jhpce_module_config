help([[
This module loads Loopy Browser v1.0.0-next.24.
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD module for loopy/1.0.0-next.24")
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD module for loopy/1.0.0-next.24")
end
