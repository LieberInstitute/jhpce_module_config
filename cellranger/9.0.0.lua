...
help([[
This module loads cell ranger version 9.0.0.
]])
...
LmodMessage("Loading LIBD SLURM module for cellranger/9.0.0")
...
prepend_path("PATH", "/jhpce/shared/libd/core/cellranger/9.0.0/cellranger-9.0.0/bin")
