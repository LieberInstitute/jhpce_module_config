...
help([[
This module loads cell ranger version 10.1.0.
]])
...
LmodMessage("Loading LIBD SLURM module for cellranger/10.1.0")
...
prepend_path("PATH", "/jhpce/shared/libd/core/cellranger/10.1.0/cellranger-10.1.0/bin")
