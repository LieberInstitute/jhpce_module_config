...
help([[
This module loads cell ranger version 9.0.1.
]])
...
LmodMessage("Loading LIBD SLURM module for cellranger/9.0.1")
...
prepend_path("PATH", "/jhpce/shared/libd/core/cellranger/9.0.1/cellranger-9.0.1/bin")
