...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for nda-tools/0.5.0")
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for nda-tools/0.5.0")
end

-- Directly activate or deactivate the conda environment
always_load("conda/3-24.3.0")
execute {cmd="conda activate /jhpce/shared/libd/core/nda-tools/0.5.0/nda_env", modeA={"load"}}
