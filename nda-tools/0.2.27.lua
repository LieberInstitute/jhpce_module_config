...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for nda-tools/0.2.27")
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for nda-tools/0.2.27")
end

-- Directly activate or deactivate the conda environment
always_load("conda/3-23.3.1")
execute {cmd="conda activate /jhpce/shared/libd/core/nda-tools/0.2.27/nda_env", modeA={"load"}}
