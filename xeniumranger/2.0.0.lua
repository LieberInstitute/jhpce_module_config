...
help([[
This module loads Xenium Ranger version 2.0.0.
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for xeniumranger/2.0.0")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for xeniumranger/2.0.0")
end

prepend_path("PATH", "/jhpce/shared/libd/core/xeniumranger/2.0.0/xeniumranger-2.0.0")
