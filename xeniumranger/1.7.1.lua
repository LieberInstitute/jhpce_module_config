...
help([[
This module loads Xenium Ranger version 1.7.1.
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for xeniumranger/1.7.1")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for xeniumranger/1.7.1")
end

prepend_path("PATH", "/jhpce/shared/libd/core/xeniumranger/1.7.1/xeniumranger-1.7.1")
