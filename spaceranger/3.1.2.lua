...
help([[
This module loads space ranger version 3.1.2
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for spaceranger/3.1.2")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for spaceranger/3.1.2")
end

prepend_path("PATH", "/jhpce/shared/libd/core/spaceranger/3.1.2/spaceranger-3.1.2/bin")
