...
help([[
This module loads space ranger version 4.1.0
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for spaceranger/4.1.0")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for spaceranger/4.1.0")
end

prepend_path("PATH", "/jhpce/shared/libd/core/spaceranger/4.1.0/spaceranger-4.1.0/bin")
