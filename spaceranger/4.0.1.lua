...
help([[
This module loads space ranger version 4.0.1
]])
...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for spaceranger/4.0.1")
...
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for spaceranger/4.0.1")
end

prepend_path("PATH", "/jhpce/shared/libd/core/spaceranger/4.0.1/spaceranger-4.0.1/bin")
