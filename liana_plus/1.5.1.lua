...
if (mode() == "load") then
    LmodMessage("Loading LIBD SLURM module for liana_plus/1.5.1")
elseif (mode() == "unload") then
    LmodMessage("Unloading LIBD SLURM module for liana_plus/1.5.1")
end

-- Directly activate or deactivate the conda environment
always_load("conda/3-24.3.0")
execute {cmd="conda activate /jhpce/shared/libd/core/liana_plus/1.5.1/liana_env", modeA={"load"}}
